...
import SymbolGrid from './components/board/SymbolGrid'
...
export default function App() {
  ...
  // Keep settings panel available in caregiver board editor as overlay if needed
        ...
        <>
          ...
          <BoardNavigator
            ...
            onPredict={(sym) => {
              ...
              recordTap(activeProfileId, previousLabel, sym.label)
            }}
          />
        </>
      )}
