...
export const DEFAULT_BOARDS = [
  {
    ...
    gridColumns: 4,
    symbols: [
      { position: 0,  symbolId: '25427', label: 'I',      wordType: 'pronoun', imageUrl: null, isCustom: false },
      { position: 1,  symbolId: '25428', label: 'you',    wordType: 'pronoun', imageUrl: null, isCustom: false },
      { position: 2,  symbolId: '25429', label: 'want',   wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 3,  symbolId: '25430', label: 'like',   wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 4,  symbolId: '5510',  label: 'go',     wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 5,  symbolId: '5512',  label: 'come',   wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 6,  symbolId: '5515',  label: 'eat',    wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 7,  symbolId: '5514',  label: 'drink',  wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 8,  symbolId: '5517',  label: 'play',   wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 9,  symbolId: '5516',  label: 'sleep',  wordType: 'verb',    imageUrl: null, isCustom: false },
      { position: 10, symbolId: '5518',  label: 'home',   wordType: 'noun',    imageUrl: null, isCustom: false },
      { position: 11, symbolId: '5519',  label: 'more',   wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 12, symbolId: '5520',  label: 'help',   wordType: 'social',  imageUrl: null, isCustom: false },
      { position: 13, symbolId: '5521',  label: 'stop',   wordType: 'social',  imageUrl: null, isCustom: false },
      { position: 14, symbolId: '5522',  label: 'yes',    wordType: 'social',  imageUrl: null, isCustom: false },
      { position: 15, symbolId: '5523',  label: 'no',     wordType: 'social',  imageUrl: null, isCustom: false },
    ]
  },
  {
    id: 'board_feelings',
    ...
    gridColumns: 4,
    symbols: [
      { position: 0, symbolId: '5524', label: 'happy',   wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 1, symbolId: '5525', label: 'sad',     wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 2, symbolId: '5526', label: 'angry',   wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 3, symbolId: '5527', label: 'scared',  wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 4, symbolId: '5528', label: 'tired',   wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 5, symbolId: '5529', label: 'hungry',  wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 6, symbolId: '5530', label: 'hurt',    wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 7, symbolId: '5531', label: 'good',    wordType: 'descriptor', imageUrl: null, isCustom: false },
    ]
  },
  {
    id: 'board_food',
    ...
    gridColumns: 4,
    symbols: [
      { position: 0, symbolId: '5532', label: 'water',   wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 1, symbolId: '5533', label: 'milk',    wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 2, symbolId: '5534', label: 'juice',   wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 3, symbolId: '5535', label: 'bread',   wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 4, symbolId: '5536', label: 'apple',   wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 5, symbolId: '5537', label: 'banana',  wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 6, symbolId: '5538', label: 'rice',    wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 7, symbolId: '5539', label: 'cookie',  wordType: 'noun', imageUrl: null, isCustom: false },
    ]
  },
  {
    id: 'board_school',
    ...
    gridColumns: 4,
    symbols: [
      { position: 0, symbolId: '5540', label: 'school',  wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 1, symbolId: '5541', label: 'teacher', wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 2, symbolId: '5542', label: 'friend',  wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 3, symbolId: '5543', label: 'book',    wordType: 'noun', imageUrl: null, isCustom: false },
      { position: 4, symbolId: '5544', label: 'write',   wordType: 'verb', imageUrl: null, isCustom: false },
      { position: 5, symbolId: '5545', label: 'read',    wordType: 'verb', imageUrl: null, isCustom: false },
      { position: 6, symbolId: '5546', label: 'draw',    wordType: 'verb', imageUrl: null, isCustom: false },
      { position: 7, symbolId: '5547', label: 'learn',   wordType: 'verb', imageUrl: null, isCustom: false },
    ]
  },
  {
    id: 'board_emergency',
    ...
    gridColumns: 3,
    symbols: [
      { position: 0, symbolId: '5522', label: 'yes',    wordType: 'social', imageUrl: null, isCustom: false },
      { position: 1, symbolId: '5523', label: 'no',     wordType: 'social', imageUrl: null, isCustom: false },
      { position: 2, symbolId: '5520', label: 'help',   wordType: 'social', imageUrl: null, isCustom: false },
      { position: 3, symbolId: '5521', label: 'stop',   wordType: 'social', imageUrl: null, isCustom: false },
      { position: 4, symbolId: '5548', label: 'hurts',  wordType: 'descriptor', imageUrl: null, isCustom: false },
      { position: 5, symbolId: '5549', label: 'toilet', wordType: 'noun',   imageUrl: null, isCustom: false },
    ]
  },
]
