...
- To make VOCA more inclusive, personalized, and effective for a wider range of users, we plan to introduce the following features:

 1. Accessibility Themes
Light Theme and Dark Theme to improve comfort in different lighting conditions.
Color-Blind Friendly Themes with accessible color palettes for users with color vision deficiencies.
High-Contrast Mode to improve readability for users with visual impairments.
...
- Emotion and Communication State Detection by analyzing communication behavior and selection patterns to identify possible emotions such as frustration, happiness, or hesitation, enabling caregivers to provide appropriate support.
- Progress Tracking to monitor improvements in communication speed and efficiency over time, helping caregivers and therapists evaluate user development.

These enhancements aim to make VOCA more accessible, adaptive, and user-centered, empowering communicators with diverse abilities to express themselves more effectively and independently.
